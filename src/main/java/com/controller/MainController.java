...
public class MainController implements Initializable {
    ...
    public void Manager_Login(ActionEvent event) throws IOException {
        CommonTask.pageNavigation("/DayTripsD5/BookingView.fxml",Main.stage,this.getClass(),"Manager Login", 600, 400);
    }
    public void Customer_Login(ActionEvent event) throws IOException {
        CommonTask.pageNavigation("/DayTripsD5/login.fxml",Main.stage,this.getClass(),"Manager Login", 600, 400);
    }
